...
export default function RightBottom() {
    ...
    series2.stroke = am4core.color("#F7241E");
    ...
    series3.fill = am4core.color("#ffff");
    ...
    series4.fill = am4core.color("#ffff");
    series4.fillOpacity = 0.1;

    // Add cursor
    chart.cursor = new am4charts.XYCursor();
    return (
        <div id="chartdiv" style={{ width: "100%", height: "300px" }} className="bg-dark" >
        </div>
    )
}